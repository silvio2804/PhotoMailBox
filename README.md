...
## Goal
The goal of this project is to implement a smart letter box for the letters. 

**Use case**:
* The post man inserts a letter inside the letter box. The esp32 is placed inside the box taking a photo of the content.
* The photo will be sent to an MQTT server
* A client python downloads and shows the image.
